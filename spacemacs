...
you should place your code here."
  ...
  (setq
   ...
   org-default-notes-file "~/org/in-list.org"
   org-bullets-bullet-list '("*")))
  ;; (define-key evil-normal-state-map (kbd "ot" ))
