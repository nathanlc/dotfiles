...
-- vim.keymap.set({'n'}, '<leader>a', 'a', {silent = true})
-- local object_ids = { "<", ">", "{", "}", "[", "]", "(", ")", "'", '"', "`", "a", "b", "c", "i", "f", "l", "p", "w", "W" }
-- for _, o in ipairs(object_ids) do
--     vim.keymap.set({'n'}, 'i' .. o, 'vi' .. o, {silent = true})
--     vim.keymap.set({'n'}, 'a' .. o, 'va' .. o, {silent = true})
-- end

-- vim.api.nvim_create_autocmd('BufEnter', {
--     group = vim.api.nvim_create_augroup('nathanlc:BufEnter', {clear=true}),
--     pattern = {"*"},
--     callback = function(ev)
--         for _, o in ipairs(object_ids) do
--             vim.keymap.set({'n'}, 'i' .. o, 'vi' .. o, {silent = true, buffer=ev.buf})
--             vim.keymap.set({'n'}, 'a' .. o, 'va' .. o, {silent = true, buffer=ev.buf})
--         end
--     end
-- })
...
-- Projects
vim.keymap.set({'n'}, '<leader>pe', [[<Cmd>lua require('plugins.project.project').edit_project_config()<CR>]], {silent=true})
...
vim.keymap.set({'n'}, '<leader>pJ', [[<Cmd>lua require('plugins.project.project').open_jira()<CR>]], {silent=true})
vim.keymap.set({'n'}, '<leader>pP', [[<Cmd>lua require('plugins.project.project').open_pr()<CR>]], {silent=true})
...
vim.api.nvim_set_keymap('n', '<D-h>', '<Cmd>vertical-resize -5<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<D-j>', '<Cmd>resize -5<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<D-k>', '<Cmd>resize +5<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<D-l>', '<Cmd>vertical-resize +5<CR>', {noremap = true, silent = true})
...
-- Config / Clipboard
vim.keymap.set({'n'}, '<leader>cc', function() require('plugins.project.project').open_project_tab('~/sandbox/mine/dotfiles') end, {silent=true})
...
vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(_, bufnr)
        ...
        vim.keymap.set("n", "<leader>b=", vim.lsp.buf.format, bufopts)
