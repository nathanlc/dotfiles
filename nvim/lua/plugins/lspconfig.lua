...
nvim_lsp.intelephense.setup({ on_attach = on_attach }) -- PHP - npm install -g intelephense
nvim_lsp.tsserver.setup({ on_attach = on_attach }) -- JavaScript - npm install -g typescript typescript-language-server
nvim_lsp.elmls.setup({ on_attach = on_attach }) -- Elm - npm install -g @elm-tooling/elm-language-server elm-format
...
nvim_lsp.gopls.setup({ on_attach = on_attach }) -- Go - cd /tmp && GO111MODULE=on go get golang.org/x/tools/gopls@latest
nvim_lsp.pyright.setup({ on_attach = on_attach }) -- Python - npm install -g pyright
