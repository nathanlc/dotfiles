...
# c.editor.command = ['/opt/homebrew/bin/nvr', '--servername', '/tmp/nvimsocket-dotfiles', '--remote-tab', '{file}', '-c', 'normal {line}G{column0}l']
# c.editor.command = ['/opt/homebrew/bin/nvr', '--servername', '/tmp/nvimsocket-dotfiles', '--remote-tab', '{file}']
c.editor.command = ["/opt/homebrew/bin/kitty", "--single-instance", "-T", "auxiliary text edit", "nvim", "{file}", "+startinsert", "+call cursor({line}, {column})"]
...
config.bind(",tw", "config-cycle tabs.width 12% 18%")
