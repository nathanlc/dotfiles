...
def parse_ssh_config [conf: list<any>] {
  ssh_m config_string $conf
}

def --env aws_credentials [profile: string] {
  aws_m set_credentials $profile
}
